#!/usr/bin/env python3
"""
documentation création d'une classe neuro task 6:  Train Neuron
...
class Neuron:
    """ adding a cost function, and a logarithmic loss
      calcul,evaluation, gradient descent, trainning """
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05, verbose=True, graph=True, step=100):
        ...
        # forward the last descent gradient
        A, cost = self.evaluate(X, Y)
