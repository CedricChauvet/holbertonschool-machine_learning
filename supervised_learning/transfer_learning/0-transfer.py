#!/usr/bin/env python3
""" first program of transfer learning, to be continued"""
"""
...
def prepare_cifar():
    ...
    #checking everything is ok, and it is! 
...
# Get the InceptionResNET model in order to dothe transfer learning
...
#graph with accuracy and loss along epochs
