...
class WGAN_clip(keras.Model) :
    ...
    def __init__( self, generator , discriminator , latent_generator, real_examples, batch_size=200, disc_iter=2, learning_rate=.005):
        ...
        self.generator.loss = lambda x : - tf.math.reduce_mean( input_tensor = x, axis=None, keepdims=False, name=None)
        ...
        self.discriminator.loss = lambda x,y : - tf.math.reduce_mean( input_tensor = x, axis=None, keepdims=False, name=None)\
            + tf.math.reduce_mean( input_tensor = y, axis=None, keepdims=False, name=None)
    ...
    def train_step(self, useless_argument):
        ...
        for _ in range(self.disc_iter):
            ...
            #self.discriminator.kernel.trainable = True
            #self.discriminator.bias.trainable = False
